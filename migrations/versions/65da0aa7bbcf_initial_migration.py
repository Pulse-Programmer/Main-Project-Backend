...
Revision ID: 65da0aa7bbcf
Revises: 
Create Date: 2024-08-06 17:05:11.828234
...
def upgrade():
    ...
    sa.Column('fileupload_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['fileupload_id'], ['fileuploads.id'], name=op.f('fk_jobseekers_fileupload_id_fileuploads')),
